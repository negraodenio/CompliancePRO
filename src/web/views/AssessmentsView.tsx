...
const AGENTIC_LIGHT_10_DIMS = [
  { id: '1', name: 'Agent Identity & Registry' },
  { id: '2', name: 'Tool Scoping & Least Privilege' },
  { id: '3', name: 'Human-in-the-Loop (HITL) Gate' },
  { id: '4', name: 'Circuit Breaker & Loops' },
  { id: '5', name: 'Prompt Defense & Guardrails' },
  { id: '6', name: 'Data Privacy & PII Sanitization' },
  { id: '7', name: 'Tamper-Evident Audit Trail' },
  { id: '8', name: 'Secrets & Credential Isolation' },
  { id: '9', name: 'Model & Output Drift Monitoring' },
  { id: '10', name: 'FinOps & Token Budget Quotas' }
];

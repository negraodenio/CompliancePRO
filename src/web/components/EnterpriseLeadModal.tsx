...
export const EnterpriseLeadModal: React.FC<EnterpriseLeadModalProps> = ({ onClose, featureContext }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md animate-in fade-in">
      <div className="glass-panel w-full max-w-2xl bg-[#0c101d] border border-cyan-500/40 rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        
        {/* Top Header */}
        <div className="p-5 sm:px-6 bg-[#0e1426] border-b border-surface-border flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">Governança contínua, telemetria em tempo real e ciclo de vida de IA</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        {/* Modal Body */}
        <div className="p-6 sm:p-7 overflow-y-auto space-y-6 text-xs text-slate-300 font-sans leading-relaxed">
          
          {submitted ? (
            <div className="p-8 text-center space-y-4 bg-[#080d1a] rounded-2xl border border-emerald-500/40 animate-in zoom-in-95">
              <div className="w-12 h-12 mx-auto rounded-full bg-emerald-950 text-emerald-400 border border-emerald-800 flex items-center justify-center">
              ...
              <div className="pt-2">
                <button
                  onClick={onClose}
                  className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-black text-xs font-bold shadow-glow cursor-pointer"
                >
            ...
            <>
              ...
              <div className="bg-[#080d1a] p-4 rounded-xl border border-surface-border space-y-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 bg-[#080c16] rounded-xl border border-slate-700 text-xs text-white focus:outline-none focus:border-cyan-500"
                    />
                  </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 bg-[#080c16] rounded-xl border border-slate-700 text-xs text-white focus:outline-none focus:border-cyan-500 resize-none"
                  />
                </div>
                ...
                <div className="pt-2 flex items-center justify-between">
                  ...
                  <button
                    type="submit"
                    className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-black text-xs font-bold flex items-center space-x-2 shadow-glow cursor-pointer transition-all"
                  >

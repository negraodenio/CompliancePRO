...
# Let's inspect the file up to line 232
base_text = text[:text.find('// 12. Fallback') + len('// 12. Fallback')]
# Find the end of getAgentBusinessAndSipoc function
end_get_agent = text.find('\n}\n', text.find('export function getAgentBusinessAndSipoc')) + 3
clean_base = text[:end_get_agent]
...
print('Cleaned and updated agent-sipoc-mapper.ts')

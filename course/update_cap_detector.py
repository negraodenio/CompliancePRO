...
export function extractDeclaredToolsFromContent(content: string): string[] {
  ...
  // Matches quoted ("name": "...") and unquoted (name: "...") inside tools/functions array or schema objects
...
print('Updated src/core/capability-detector.ts with toolsBlocks extraction')
